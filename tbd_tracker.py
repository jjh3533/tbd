...
def run_tracker():
    ...
    summary_header = [
        ...
        f"• **변동 상품**: {changed_total}개 (📈 상승 {increased_count} / 📉 하락 {decreased_count} / 🔴 품절 {out_of_stock_count} / 🟢 재입고 {back_in_stock_count})",
        "\n---",
    ]
    ...
    if detail_messages:
        ...
        final_msg += "\n\n👉 [스마트스토어 수정 바로가기](https://sell.smartstore.naver.com/)"
    else:
        final_msg = "\n".join(summary_header) + "\n\n✨ 가격 및 재고 변동 사항이 없습니다."
